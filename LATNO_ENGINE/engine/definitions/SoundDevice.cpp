#include "../declarations/SoundDevice.h"
#include "../declarations/SoundSource.h"
...
namespace Latno
{
	...
	void SoundDevice::PlaySound()
	{
		SoundSource speaker;
		speaker.Play(currentAudio);
	}

	void SoundDevice::Play(ALuint audio)
	{
		currentAudio = audio;
		ThreadManager::CreateThread(PlaySound);
	}
